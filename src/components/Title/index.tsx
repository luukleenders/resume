  ...
  return (
    <div
      className={classNames(
        'box-content flex items-end justify-start bg-white/30 px-4 py-8 backdrop-blur-lg',
        heightClasses,
        className
      )}
    >
      <h1>
        <span className='flex flex-col text-slate-900'>
          ...
          <span className='text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl'>
